...
var alldiv = document.querySelector('div');
for(let j = 0;j < alldiv.length;j++)
    alldiv[I].classList.add('cls1');
...
function movedisk(k)//k-th instruction
{
  ...
  if(q.length > 0)
  {
     ...
     x1 = disk1.style.left;
     y1 = disk1.style.top;
     y1 = (parselnt(y1.substring(0,y1.length-2))
          - THICKNESS) + 'px';
  }
